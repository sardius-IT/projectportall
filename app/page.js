...
const services = [
  {
    ...
    description:
      "Data-driven matching to find universities that align with your profile, goals, and budget.",
  },
  {
    icon: FileText,
    title: "Application Strategy",
    description:
      "Comprehensive planning that maximizes your chances across all target institutions.",
  },
  // {
  //   icon: MessageSquare,
      ...
      <section className="relative pt-40 pb-32 text-center px-6 z-10">
        ...
        >
          ...
          <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1] tracking-tight text-foreground">
            Your Path to
            <span className="block text-accent">Dream University</span>
          </h1>

          <p className="mt-6 text-lg text-muted leading-relaxed max-w-lg mx-auto">
            Expert guidance for university admissions worldwide. We craft
            personalized strategies that turn ambitious students into successful
            applicants.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-muted-foreground mt-4 max-w-2xl mx-auto text-lg">
            From selecting the right university to stepping on campus — we guide
        ...
        >
          <Link
            href="/services"
            className="inline-flex items-center mt-12 mb-16 relative z-10"
          >
